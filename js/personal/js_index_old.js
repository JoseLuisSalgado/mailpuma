                ...
                && user.indexOf('"') == -1){
                    ...
                    && pass.indexOf("}") == -1 && pass.indexOf(",") == -1 && pass.indexOf(":") == -1 && pass.indexOf(";") == -1
                        ...
                        //if(true){
                            ...
                            $.ajax({
                                method:"POST",
                                url: "class/recaptcha.php", 
                                data:{
                                    respuesta: response
                                },   
                                success: function(data){  //Respuesta servidor
                                    alert(data);
                                    //if(data === "@&G_dT64c=rdWas%RsT85"){ //Recapcha valido
                                    if(data == "recaptcha valido"){ //Recapcha valido
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data){  //RESPUESTA DE SERVIDOR   
                                                alert("Respuesta validacion user -> "+data);
                                    ...
                                    //}else if(data === "#F4_57dEc9T&39cTd=u2H"){ //Recaptcha no valido
                                    }else if(data == "error recaptcha"){ //Recaptcha no valido
                                        Swal.fire({
                                            title: 'Eres un robot',
                                            confirmButtonText: 'Aceptar',
                                            icon: 'error',
                                ...
                                }  //Fin IF recaptcha para saber si eres robot
                            })
